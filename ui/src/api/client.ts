...
export const explainApi = {
  ...
  explainReference: (refId: string, refType: string) =>
    api
      .post("/explain/reference", { ref_id: refId, ref_type: refType })
      .then((r) => r.data.data),
};
...
export const sessionApi = {
  ...
  create: (title: string) =>
    api.post("/sessions", { title }).then((r) => r.data.data),
  update: (id: string, title: string) =>
    api.patch(`/sessions/${id}`, { title }).then((r) => r.data.data),
  delete: (id: string) =>
    api.delete(`/sessions/${id}`).then((r) => r.data.data),
};
