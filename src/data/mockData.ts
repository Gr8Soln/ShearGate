import type { Calculation, ConnectionInputs, CalculationResult } from '../types';
...
export const mockCalculations: Calculation[] = [
  {
    ...
    questionText: "A double angle connection with 4 x M20 Grade 8.8 bolts. Angles: 100x100x10mm, S275 steel. Check block shear capacity.",
    inputs: {
      boltGrade: "8.8",
      boltDiameter: 20,
      numberOfBolts: 4,
    ...
    steps: [
      ...
      },
      {
        ...
        content: "The gross shear area along the failure plane:\nAv = (3p + e) × t\nAv = (3 × 70 + 50) × 10\nAv = 2600 mm²",
        clause: "6.2.4",
      ...
      },
      {
        ...
        content: "The design capacity is the minimum of the two modes:\nPbs = min(Pbs1, Pbs2)\nPbs = min(594, 1199.7)\nPbs = 594 kN",
        clause: "6.2.4",
...
export const mockCalculate = (inputs: ConnectionInputs): Promise<CalculationResult> => {
  return new Promise((resolve) => {
    setTimeout(() => {
      ...
      resolve({
        ...
        verdict: blockShearOccurs ? "UNSAFE - Block shear will occur" : "SAFE - Block shear will not occur",
